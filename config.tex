...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 页脚设置（已调整比例：左 0.4，中 0.5，右 0.1）
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\setbeamertemplate{footline}{%
  \begin{tikzpicture}[remember picture,overlay]
    % 1. 左边色块：宽度调整为 0.4
    \node[fill=lightblue, minimum width=0.4\paperwidth, minimum height={0.4cm+1pt}, anchor=south west]
         at ([xshift=-1pt,yshift=-1pt]current page.south west) (leftblock) {};
         
    % 2. 中间色块：起点跟在 0.4 后面，自身宽度调整为 0.5
    \node[fill=midblue, minimum width=0.5\paperwidth, minimum height={0.4cm+1pt}, anchor=south west]
         at ([xshift=0.4\paperwidth-1pt,yshift=-1pt]current page.south west) (midblock) {};
         
    % 3. 右边色块：起点在 0.9 (0.4 + 0.5)，宽度保持 0.1
